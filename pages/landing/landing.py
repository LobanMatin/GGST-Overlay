...
logo_img = Image.open("pages/landing/logo.png")
...
class LandingPage(tk.Frame):
    def __init__(self, controller, parent, root):
        ...
        logo_img = logo_img.resize((round(controller.width * 0.7), round(controller.height * 0.2)), Image.LANCZOS)
        logo_img = ImageTk.PhotoImage(logo_img, master=title_canvas)

        title_canvas.create_image(0, 0, image=logo_img, anchor="nw")
        title_canvas.place(relx=0.5, rely=0.1, anchor="n")
